<?php
$valor = array(
    'sarea'=>$_POST['sarea'],           //codigo de area sin el 0 ej: 212
    'stelefono'=> $_POST['stelefono']   //telefono sin codigo
);
//open connection
$ch = curl_init();
...
$data['error'] = strpos($resultado, "servicio no encontrado") == False ? '' : 'N&uacute;mero de servicio no encontrado.';
